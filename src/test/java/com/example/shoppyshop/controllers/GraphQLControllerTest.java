...
class GraphQLControllerTest {
  ...
  private static final Map<String, String> productsRequest,
      categoriesRequest,
      categoriesWithProductsRequest;
  ...
  void graphQLControllerTest(@Autowired MockMvc mvc) throws Exception {
    ...
    String expCategoriesWithProducts =
        String.format(
            "{\"data\":{\"categories\":[{\"id\":%s,\"name\":\"test category"
                + " 1\",\"products\":[{\"name\":\"my fancy product 1\"},{\"name\":\"my fancy"
                + " product 2\"}]},{\"id\":%s,\"name\":\"test category 2\",\"products\":[]}]}}",
            c1.getId(), c2.getId());
    String expCategories =
        "{\"data\":{\"categories\":[{\"name\":\"test category 1\"},{\"name\":\"test category"
            + " 2\"}]}}";
    String expProducts =
        "{\"data\":{\"products\":[{\"price\":100,\"name\":\"my fancy product"
            + " 1\"},{\"price\":200,\"name\":\"my fancy product 2\"}]}}";

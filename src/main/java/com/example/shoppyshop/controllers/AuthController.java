...
public class AuthController {
  ...
  public AuthController(
      AuthenticationManager authManager, ModelMapper modelMapper, UserService userService) {
  ...
  public ResponseEntity authenticate(HttpServletRequest req, @Valid @RequestBody AuthRequest body) {
    //        TODO: probably should move that to servcice layer, but i'm not sure - there are to
    // many http-related things
